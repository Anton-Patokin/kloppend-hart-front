<?php
    ...
    class PoiAvgWeekDAO extends \core\dao\GenericDAO {
        public function __construct() {
            global $pdo;
            parent::init($pdo, 'poi_avg_week');
        }
        ...
        public function getByPrimaryKey($values, $identifiers = array('day', 'source_reference_poi_mectric_id')) {
