...
require_once "../../facebook/api/BaseFacebookApi.class.php";
...
class FacebookApi extends BaseFacebook {
   ...
   */
  public function __construct($config = array('appId'  => '335217969873503', 'secret' => '979f1d1d5c4e4499873827306f50cd8f')) {
    if (!session_id()) {
      session_start();
    }
  ...
  public function getFacebookPlaceById($id){
    // var_dump($id);
      return $this->api("$id");
  }
  
  public function getFacebookPlacesByGeoLocation($geoLocation, $distance = 50, $limit = 1500){
      $center = "$geoLocation->latitude,$geoLocation->longitude";
      $result = $this->api("search?type=place&center=$center&distance=$distance&limit=$limit");
      return $result['data'];
  }
