	...
	<div ng-class="{sidenavtest: !sideNavtest}" class="navbar navbar-inverse navbar-fixed-left sidenav">
		...
		<div class="icons">
			<ul ng-click="closeSideNav(); toggleTrending('close');">
				<a ng-click="home(); closeSideNav(); enableFooter();" href=""><li ng-class="{ active: isActive('')}"><img src="<?= $rootPath ?>images/newdesign/{{isActive('') && 'home_active.png' || 'home.png'}}"><span class="kha-logo"><img src="<?= $rootPath ?>images/newdesign/logo-small.png"></span></li></a>
				...
				<a href="#section1/over_de_stad/show/Openbare-diensten"><li ng-class="{ active: isActive('/section1/over_de_stad/show')}"><img src="<?= $rootPath ?>images/newdesign/{{isActive('/section1/over_de_stad/show') && 'city_active.png' || 'city.png'}}"><span>Over de stad</span><img class="pull-right" ng-src="<?=$rootPath?>/images/newdesign/{{isActive('/section1/over_de_stad/show') && 'arrow_white.png' || 'arrow.png'}}"></li></a>
				<a href="#section1/winkel/show/kleding"><li ng-class="{ active: isActive('/section1/winkel/show')}"><img src="<?= $rootPath ?>images/newdesign/{{isActive('/section1/winkel/show') && 'sale_active.png' || 'sale.png'}}"><span>Shopping</span><img class="pull-right" ng-src="<?=$rootPath?>/images/newdesign/{{isActive('/section1/winkel/show') && 'arrow_white.png' || 'arrow.png'}}"></li></a>
				<a href="#section1/uitgaan/show/film"><li ng-class="{ active: isActive('/section1/uitgaan/show')}"><img src="<?= $rootPath ?>images/newdesign/{{isActive('/section1/uitgaan/show') && 'pint_active.png' || 'pint.png'}}"><span>Uitgaan</span><img class="pull-right" ng-src="<?=$rootPath?>/images/newdesign/{{isActive('/section1/uitgaan/show') && 'arrow_white.png' || 'arrow.png'}}"></li></a>
				<a href="#section1/vrije_tijd/show/sport"><li ng-class="{ active: isActive('/section1/vrije_tijd/show')}"><img src="<?= $rootPath ?>images/newdesign/{{isActive('/section1/vrije_tijd/show') && 'plane_active.png' || 'plane.png'}}"><span>Vrije tijd</span><img class="pull-right" ng-src="<?=$rootPath?>/images/newdesign/{{isActive('/section1/vrije_tijd/show') && 'arrow_white.png' || 'arrow.png'}}"></li></a>
				<a href="#section8"><li ng-class="{ active: isActive('/section8')}"><img src="<?= $rootPath ?>images/newdesign/{{isActive('/section8') && 'sun_active.png' || 'sun.png'}}"><span>Weer</span><img class="pull-right" ng-src="<?=$rootPath?>/images/newdesign/{{isActive('/section8') && 'arrow_white.png' || 'arrow.png'}}"></li></a>
				<a href="#section7"><li ng-class="{ active: isActive('/section7')}"><img src="<?= $rootPath ?>images/newdesign/{{isActive('/section7') && 'car_active.png' || 'car.png'}}"><span>Verkeer</span><img class="pull-right" ng-src="<?=$rootPath?>/images/newdesign/{{isActive('/section7') && 'arrow_white.png' || 'arrow.png'}}"></li></a>
				<a href="#section6"><li ng-class="{ active: isActive('/section6')}"><img src="<?= $rootPath ?>images/newdesign/{{isActive('/section6') && 'velo_white.png' || 'velo.png'}}"><span>Velo</span><img class="pull-right" ng-src="<?=$rootPath?>/images/newdesign/{{isActive('/section6') && 'arrow_white.png' || 'arrow.png'}}"></li></a>
				<li></li>
			</ul>
		</div>
	</div>
